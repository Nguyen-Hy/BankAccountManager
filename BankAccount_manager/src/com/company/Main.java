...
//            System.out.println("\t||  8.  GHI DANH SÁCH TÀI KHOẢN RA FIE                          ||");
            ...
            switch (choose) {
                ...
                case 5: {
                    if( abcBanks.size() == 1 ){
                        System.out.println("\tDanh sách tài khoản cần ít nhứt 2 thành viên để thực hiện giao dịch");
                    }else if( abcBanks.size() == 0){
                        System.out.println("\tDanh sách tài khoản rỗng! ");
                    }else{
                        transfers(abcBanks);
                    }
...
//
//                if (checkSent == null) {
//                    System.out.println("\tKhông tìm thấy tài khoản có số \" " + acSent + " \" ");
//                    System.out.print("\tNhập lại: ");
//                }
//            } while (checkSent == null);
//
//            var acRe = "";
//            var checkRe = new ABC_BANK();
//            var checkRe_se = new ABC_BANK();
//
//            System.out.print("\n\tNhập số tài khoản nhận: ");
//            do {
//                acSent = scanner.next();
//                checkRe = findAcByNum(acRe, abc_banks);
//
//                if (checkRe == null) {
//                    System.out.println("\tKhông tìm thấy tài khoản có số \" " + acSent + " \" ");
//                    System.out.print("\tNhập lại: ");
...
//            } while (checkRe == null);
//
//            var checkMoney = checkMoney(acSent, abc_banks);
//            if (checkMoney != true) {
//                System.out.println("Số tiền trong tài khoản \" " + acSent + "\" không đủ để thực hiện giao dịch.");
//                break;
//            }
//
//        }while (true);
...
//    }
    ...
    private static boolean transfers ( ArrayList<ABC_BANK> abc_banks ){
        ...
        var checkIdSender = findAcByNum(sender, abc_banks);
        var checkMoney = checkMoney(sender, abc_banks);
        if( checkIdSender != null ){
            ...
            if( ! sender.equals(receiver) ){
                var checkIdReceiver = findAcByNum(receiver, abc_banks);
                if( checkIdReceiver != null ){

                    checkIdSender.minusMoney(money1);
                    checkIdReceiver.addMoney(money1);
    ...
    private static ABC_BANK findRe( ArrayList<ABC_BANK> abc_banks, String acNumberSe, String acNumberRe ){
        for( var i : abc_banks ){
            if( i.getAcountNumber().equals(acNumberRe) && !i.getAcountNumber().equals(acNumberSe)){
                return i;
            }
        }
        return null;
